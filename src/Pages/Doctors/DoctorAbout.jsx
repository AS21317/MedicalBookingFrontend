    ...
    <div>
      ...
      <div className="mt-12">
        ...
        <ul className="grid sm:grid-cols-2 gap-[30px] pt-4 md:p-5">
            ...
            <span className="Mtext-yellowColor text-[15px] leading-6 font-semibold">
              {formateDate(item.startingDate)} - {formateDate(item.endingDate)}
            </span>
            <p className="text-[16px] leading-6 font-medium Etext-textColor">
              {item.position}
            </p>
            <p className="text-[14px] leading-5 font-medium Hltext-textColor">
              {item.hospital}
            </p>
          </li>)}
